...
#%% Plotting modified efficiency 
plt.plot(kappa_range,efficency[:,0], linestyle='--', color='b', linewidth=2, dashes=(10, 2), label = r'$T_D = 10^{-4} K$')
plt.plot(kappa_range,efficency[:,1], linestyle='-.', color='g', linewidth=2, dashes=(10,2,3,2), label = r'$T_D = 0.005 K$')
plt.plot(kappa_range,efficency[:,2], linestyle=':', color='r', linewidth=2, dashes=(2, 1), label = r'$T_D = 0.01 K$')
...
#%% Plotting work extraction for -ve z
plt.plot(kappa_range,work[:,0], color='b',label = r'$T_D = 10^{-4} K$')
plt.plot(kappa_range,work[:,0], color='g',label = r'$T_D = 0.005 K$')
plt.plot(kappa_range,work[:,0], color='r',label = r'$T_D = 0.01K$')

plt.tick_params(axis='both', which='major', labelsize=12)
plt.ylabel('$W_{ext}$',fontsize=18)
plt.xlabel('$\kappa$',fontsize=18)
plt.legend(fontsize=12)
